<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"/vagrant/tp5/public/../application/admin/view/login/login.html";i:1533740886;}*/ ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml"><!--Head--><head>
    ...
    <!--Beyond styles-->
    <link id="beyond-link" href="http://www.php.com/static/admin/style/beyond.css" rel="stylesheet">
        ...
        <form action="" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="loginbox-textbox">
                    ...
                    <img  style="float:left ; padding-top: 10px; cursor:pointer;" src="<?php echo captcha_src(); ?>" alt="captcha" onclick="this.src='<?php echo captcha_src(); ?>?'+Math.random();" />
                </div>
